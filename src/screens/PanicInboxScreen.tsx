...
import {
  ArrowLeft, SlidersHorizontal, Siren, Map as MapIcon, Eye,
  LifeBuoy, Navigation2, ShieldCheck,
                      ...
                      {RESPONSES.map(({ value, label, Icon }) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <Text style={[styles.actText, selected && { color: colors.accent }]}>{label}</Text>
                          </Pressable>
                        );
                      })}
                    </View>
...
const styles = StyleSheet.create({
  ...
  actBtnOn: { backgroundColor: colors.ink, borderColor: colors.ink },
